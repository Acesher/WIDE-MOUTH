...
public class UIPlayerSelection : MonoBehaviourPunCallbacks
{
    ...
    /*    private void UpdateCharacterModel(int selection)
        {
            _skinImage.sprite = _sprites[selection];
        }*/
    #endregion
    ...
    public void KickPlayer()
    {
        ...
        {
            if (!player.IsLocal && _usernameText.text.Equals(player.NickName))
            {
                Kick(player);
                return;
            }
    ...
    public override void OnMasterClientSwitched(Player newMasterClient)
    {
        ...
        {
            //ShowMasterClientUI();
            Debug.Log("New host has been assigned");
        }
    }
